...
static void ufs_fixup_device(struct ufs_hba *hba)
{
	if (hba->dev_quirks & UFS_DEVICE_QUIRK_BROKEN_LINEREST)
		ufshcd_dme_peer_set(hba, UIC_ARG_MIB(0x9564), 0x30142);
}
